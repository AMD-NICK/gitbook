...
### Зарождение идеи <a href="#undefined" id="undefined"></a>
...
### Неудачная попытка автоматизации <a href="#undefined" id="undefined"></a>
...
### Первый шаг в нужном направлении <a href="#undefined" id="undefined"></a>
...
1 апреля 2016, пока другие [смеялись над белыми спинами](https://ru.wikipedia.org/wiki/%D0%94%D0%B5%D0%BD%D1%8C\_%D1%81%D0%BC%D0%B5%D1%85%D0%B0), я наблюдал надпись «Одобрено» в панели управления unitpay.ru — агрегаторе, с которым я решил работать. _upd. позже мы заключили договора сразу с несколькими другими агрегаторами, чтобы выбрать у каждого лучшие из условий_

***

### Начало работы <a href="#undefined" id="undefined"></a>
...
### Кстати, о прибыли <a href="#undefined" id="undefined"></a>
...
### Автодонат - говно <a href="#undefined" id="undefined"></a>
...
> [gm-donate.ru IGS #1](https://imgur.com/2R6A9)
...
> [gm-donate.ru IGS #2](https://imgur.com/0YPle)
...
### Я зря работал? <a href="#undefined" id="undefined"></a>
...
### Я теперь не один <a href="#undefined" id="undefined"></a>
...
### Проблемы работы в команде <a href="#undefined" id="undefined"></a>
...
### Окей, поехали! <a href="#undefined" id="undefined"></a>
...
### "Че ты мне тут втираешь?" <a href="#undefined" id="undefined"></a>
...
Навскидку 80% тех, кому я писал насчет автодоната сразу или не сразу грубо или деликатно, но посылали меня на@@й. Я уже [писал об этом здесь](broken-reference), поэтому не буду повторяться.
...
### Эпилог <a href="#undefined" id="undefined"></a>
...
Пока [другие принимают платежи вручную](broken-reference), тратя свои силы и время на общения с донатерами, наши клиенты радуются повышенной доходности и полной автоматизации. Для этого был создан gm-donate.ru и с задачей он справляется лучше всех
